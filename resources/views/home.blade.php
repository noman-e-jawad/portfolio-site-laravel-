...
<body id="main-body" class="bg-primary-black  mx-auto lg:max-w-[1140px]" data - scroll - section>
    <header data - scroll - section
        class="py-2 flex justify-between items-center max-h-20 absolute top-0 lg:min-w-[1140px] md:min-w-[920px] sm:min-w-full">
    ...
    <section class="pb-0 pt-15 w-full md:flex-row lg:flex-row flex-col " data - scroll - section>
        <div class="lg:w-[39%] w-3/4">
            <img src="{{ asset('img/women.jpg') }}" alt="Shuvro">
        </div>
        <div class="lg:w-[61%] ml-4 p-4 lg:p-0 lg:gap-3 gap-4 flex flex-col items-start">
    ...
    <section class="flex-col gap-32 half-bg w-full " data - scroll - section>
        <div class=" flex justify-center items-center lg:gap-5 w-full gap-3 flex-wrap lg:flex-nowrap">
            <div
                class="p-10 bg-primary-background lg:w-1/3 md:w-1/3 flex gap-3 flex-col items-start w-[calc(50%-theme('gap.3'))]">
            ...
            <div
                class="p-10 bg-dark-red lg:w-1/3 flex gap-3 flex-col items-start md:w-1/3 w-[calc(50%-theme('gap.3'))]">
            ...
            <div
                class="p-10 bg-primary-background lg:w-1/3 flex  gap-3 flex-col items-start md:w-1/3 w-[calc(50%-theme('gap.3'))]">
        ...
        <div class=" flex justify-center items-center w-full">
            <div class="m-2 w-1/3 flex flex-col justify-between items-center">
                <h1 class="text-light-red text-8xl">
                    12
                </h1>
                <h3>
                    Years
    ...
    <footer class="min-h-[100px]  flex justify-between items-center relative px-5" data - scroll - section>
